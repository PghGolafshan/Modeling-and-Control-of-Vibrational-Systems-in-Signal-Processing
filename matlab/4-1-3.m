function triple_impulse_response
    % Constants
    ...
    for i = 1:N
        ...
        [t, sol] = ode45(@(t, q) odefun_triple_impulse(t, q, a(i), b(i), c(i), w), t_span, initial_conditions);
...
function dydt = odefun_triple_impulse(t, q, a, b, c, w)
    % Approximation of triple impulse function (r = delta(t)^3)
    if abs(t) < 1e-9 % Extremely narrow width
        A = 1e15; % Extremely high amplitude
    else
        A = 0;
    end
